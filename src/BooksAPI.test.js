...
describe("BooksAPI.search", () => {
    test("0", () => {
        let callFunction = () => {
            BooksAPI.search("DROP TABLE tmp;", -1)
        }
    ...
    test("1", () => {
        let callFunction = () => {
            BooksAPI.search("UPDATE Projects SET pname = %s WHERE pid = %s", -1)
        }
    ...
    test("2", () => {
        let callFunction = () => {
            BooksAPI.search("DELETE FROM Projects WHERE pid = %s", 0)
        }
    ...
    test("4", () => {
        let callFunction = () => {
            BooksAPI.search("UPDATE Projects SET pname = %s WHERE pid = %s", 0)
        }
